...
####
## Installer for Valorant RPC. Values not defined here come from "wails_tools.nsh",
## which is generated from build/config.yml by `task assets:update`.
##
## To build this by hand, outside of Task:
## > makensis -DARG_WAILS_AMD64_BINARY=..\..\..\bin\valorant-rpc.exe project.nsi
####

## Add/Remove Programs key. Without this, wails_tools.nsh concatenates the
## company and product names into "HazeValorant RPC".
!define UNINST_KEY_NAME "ValorantRPC"

## The app's single-instance mutex, from singleInstanceID in cmd/valorant-rpc-gui.
!define APP_MUTEX "wails-app-com.its-haze.valorant-rpc-sim"
...
!define AUTORUN_VALUE "ValorantRPC"
