...
export const GITHUB_REPO_URL = "https://github.com/its-haze/valorant-rpc";
export const GITHUB_PROFILE_URL = "https://github.com/its-haze";
export const AUTHOR_WEBSITE_URL = "https://haze.sh";
export const BUG_REPORT_URL = "https://github.com/its-haze/valorant-rpc/issues/new?template=bug_report.md";
export const FEATURE_REQUEST_URL =
  "https://github.com/its-haze/valorant-rpc/issues/new?template=feature_request.md";
