  ...
  return (
    <div className="flex flex-col gap-5 text-center">
      ...
      <p className="text-muted mx-auto max-w-2xl text-base">
        Valorant RPC runs in the background and follows your client. Here's the whole loop.
      </p>
      ...
      <section className="border-accent-border bg-accent-bg flex items-start gap-3 rounded-lg border p-5 text-left">
        ...
        <div className="flex flex-col gap-1">
          <h2 className="text-base font-semibold">It doesn't launch Valorant for you</h2>
          <p className="text-muted text-sm leading-relaxed">
            Opening Valorant RPC won't open Valorant. That's deliberate: it's built to start with
            Windows, and nobody wants Valorant opening the moment they boot. Start Valorant however
            you normally do, and Valorant RPC will pick it up.
          </p>
        </div>
      </section>
