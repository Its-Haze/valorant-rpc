...
const CLOSE_ACTIONS: SelectOption[] = [
  ...
  { value: "quit", label: "Quit Valorant RPC" },
];

// The Behavior section: how the app looks and behaves around the game.
// Appearance, pausing, startup, close handling, updates.
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <SettingsCard
        ...
        description="Get notified when a new version is ready to install, so a Valorant patch never leaves you behind on a broken build. New releases are also announced in the Discord server."
        badge="Recommended"
        highlighted
