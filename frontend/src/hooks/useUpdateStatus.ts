...
import { GetUpdateStatus } from "../../bindings/github.com/its-haze/valorant-rpc/cmd/valorant-rpc-gui/guiservice";
import type { UpdateStatus } from "../../bindings/github.com/its-haze/valorant-rpc/internal/app/models";
