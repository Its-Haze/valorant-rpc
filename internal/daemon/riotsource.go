...
func NewRiotSource(client Connector, stateMgr *state.Manager, logger zerolog.Logger, newWatcher func(onUpdate func(riotchat.Presence)) presenceWatcher, opts ...RiotSourceOption) *RiotSource {
