...
// The four tables below are filled in alongside the presence builders. Until
// then this package is the rendering engine and nothing more.
var (
	knownTokens = map[Context][]string{}
	defaults    = map[Context][2]string{}
	sampleData  = map[Context]map[string]string{}
	// order carries the phase chronology the maps above cannot express.
	order = []Context{}
)
